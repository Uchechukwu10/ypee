    ...
    <div className="py-16 bg-white">
      <div className="flex flex-col justify-center items-center container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed space-y-6">
          ...
          <p>
            Our vision is a Nigeria where every young person has the skills,
            resources, and platform to become a leader in their community,
            driving both economic growth and social harmony. We focus on
            hands-on training, mentorship, and funding for young entrepreneurs
